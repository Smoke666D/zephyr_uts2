...
typedef enum
{
    ...
    SENS_I2C_POWER_VD5, 
    POWER_DRV_CTR_CHANNEL1,
    POWER_DRV_CTR_CHANNEL2,
    POWER_DRV_CTR_CHANNEL3,
    POWER_DRV_CTR_CHANNEL4,
    POWER_DRV_CTR_CHANNEL5,
    POWER_DRV_CTR_CHANNEL6,
    POWER_DRV_CTR_CHANNEL7,
    POWER_DRV_CTR_CHANNEL8,
    POWER_DRV_CTR_CHANNEL9,
    POWER_DRV_CTR_CHANNEL10,
    POWER_DRV_CTR_CHANNEL11,
    POWER_DRV_CTR_CHANNEL12,
    POWER_DRV_CTR_CHANNEL13,
    POWER_DRV_CTR_CHANNEL14,
    POWER_DRV_CTR_CHANNEL15,
    POWER_DRV_CTR_CHANNEL16,
    POWER_DRV_CTR_CHANNEL17,
    POWER_DRV_CTR_CHANNEL18,
    LIN1_PD,
    LIN2_PD,
    LIN3_PD,
    LIN4_PD,
    POWER_DRV_STS_CHANNEL1,
    POWER_DRV_STS_CHANNEL2,
    POWER_DRV_STS_CHANNEL3,
    POWER_DRV_STS_CHANNEL4,
    POWER_DRV_STS_CHANNEL5,
    POWER_DRV_STS_CHANNEL6,
    POWER_DRV_STS_CHANNEL7,
    POWER_DRV_STS_CHANNEL8,
    POWER_DRV_STS_CHANNEL9,
    POWER_DRV_STS_CHANNEL10,
    POWER_DRV_STS_CHANNEL11,
    POWER_DRV_STS_CHANNEL12,
    POWER_DRV_STS_CHANNEL13,
    POWER_DRV_STS_CHANNEL14,
    POWER_DRV_STS_CHANNEL15,
    POWER_DRV_STS_CHANNEL16,
    POWER_DRV_STS_CHANNEL17,
